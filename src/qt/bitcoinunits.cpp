...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("FEN");
    case mBTC: return QString("mFEN");
    case uBTC: return QString::fromUtf8("μFEN");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Fencoins");
    case mBTC: return QString("Pl&aring;s (1 / 1,000)");
    case uBTC: return QString("Venlas (1 / 1,000,000)");
    default: return QString("???");
    }
}
